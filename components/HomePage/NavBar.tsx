...
import styles from "@/components/HomePage/NavBar.module.scss";
  ...
  return (
    <NavBarBase>
      <div className={styles["right-container-landing"]}>
        ...
        {/* Change this to redirect to /. If you are redirected to /, if logged in, redirect to home */}
        ...
        <div className={styles["profile-container"]}>
          <Image src={profilePicture} alt="profile picture" fill></Image>
        </div>
      </div>
    </NavBarBase>
  );
